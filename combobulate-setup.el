...
(declare-function combobulate-navigate-self-end "combobulate-navigation")
(declare-function combobulate-forward-sexp-function "combobulate-navigation")
(declare-function combobulate-navigate-forward-sexp "combobulate-navigation")
(declare-function combobulate-navigate-backward-sexp "combobulate-navigation")
(declare-function combobulate-navigate-sibling-forward "combobulate-navigation")
(declare-function combobulate-navigate-sibling-backward "combobulate-navigation")
...
(defvar combobulate-key-map
  (let ((map (make-sparse-keymap "Combobulate")))
    ...
    (define-key map (kbd "C-M-f") #'combobulate-navigate-forward-sexp)
    (define-key map (kbd "C-M-b") #'combobulate-navigate-backward-sexp)
    (define-key map (kbd "C-M-n") #'combobulate-navigate-sibling-forward)
    (define-key map (kbd "C-M-p") #'combobulate-navigate-sibling-backward)
